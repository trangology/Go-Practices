...
func TestIsPrime(t *testing.T) {
	...
	if result != expected_result {
		t.Fatalf("Expected '%t' but got '%t'", expected_result, result)
	}
...
func TestGCD(t *testing.T) {
	...
	expected_result := 3
	if result != expected_result {
		t.Fatalf("Expected '%d' but got '%d'", expected_result, result)
	}
...
func TestDecrypt(t *testing.T) {
	...
	if result != expected_result {
		t.Fatalf("Expected '%x' but got '%x'", expected_result, result)
	}
}
